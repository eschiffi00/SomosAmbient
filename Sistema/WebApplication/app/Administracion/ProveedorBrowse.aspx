<%@ Page Title="" Language="C#" MasterPageFile="~/app/app.Master" AutoEventWireup="true" CodeBehind="ProveedorBrowse.aspx.cs" Inherits="WebApplication.app.Administracion.ProveedorBrowse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        function ConfirmaBorrado(e) {
            ...
            resp = confirm('¿Está seguro de borrar este cliente?');
            if (resp == true) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-8">
            <h4 class="ml-3 mb-4">Listado de Proveedores &nbsp;
                <i class="fa fa-search searchicon faborde"></i>
                <asp:LinkButton CssClass="LnkBtnExportar" runat="server" ID="btnExportar" OnClick="btnExportar_Click"><i class="fa fa-download exporticon faborde" title="Exportar Proveedores"></i></asp:LinkButton>
            </h4>
        </div>
        <div class="col-4 text-right">
            <asp:Button ID="btnNuevoProveedor" Text="Nuevo Proveedor" runat="server" CssClass="btn btn-primary" OnClick="btnNuevoProveedor_Click" />
        </div>
    </div>
    ...
    <div class="table-responsive">
        <asp:GridView ID="grdProveedores" CssClass="table table-striped table-bordered table-hover table-sm" runat="server" AutoGenerateColumns="false" >
            <Columns>
                ...
                <asp:BoundField DataField="Id" HeaderText="Id" HeaderStyle-CssClass="invisible" ItemStyle-CssClass="invisible" />
                 <asp:BoundField DataField="RazonSocial" HeaderText="Razon Social" Visible="true" />
                <asp:BoundField DataField="NombreFantasia" HeaderText="Nombre Fantasía" Visible="true" />
                <asp:BoundField DataField="CUITCUIL" HeaderText="Cuit" Visible="true" />
