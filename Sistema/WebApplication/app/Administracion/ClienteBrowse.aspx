<%@ Page Title="" Language="C#" MasterPageFile="~/app/app.Master" AutoEventWireup="true" CodeBehind="ClienteBrowse.aspx.cs" Inherits="WebApplication.app.Administracion.ClienteBrowse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-8">
            <h4 class="ml-3 mb-4">Listado de Clientes &nbsp;
        ...
        <div class="col-4 text-right">
            <asp:Button ID="btnNuevoCliente" Text="Nuevo Proveedor" runat="server" CssClass="btn btn-primary" OnClick="btnNuevoCliente_Click"  />
        </div>
    </div>
    ...
    <div class="table-responsive">
        <asp:GridView ID="grdClientes" CssClass="table table-striped table-bordered table-hover table-sm" runat="server" AutoGenerateColumns="false" >
            <Columns>
