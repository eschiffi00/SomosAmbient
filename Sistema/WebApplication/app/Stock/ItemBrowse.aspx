<%@ Page Title="" Language="C#" MasterPageFile="~/app/app.Master" AutoEventWireup="true" CodeBehind="ItemBrowse.aspx.cs" Inherits="WebApplication.app.Administracion.ItemBrowse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        function ConfirmaBorrado(e) {
            ...
            resp = confirm('¿Está seguro de borrar este Item?');
            if (resp == true) {
    ...
    <div class="row">
        <div class="col-8">
            <h4 class="ml-3 mb-4">Listado de Items &nbsp;
                ...
                <asp:LinkButton CssClass="LnkBtnExportar" runat="server" ID="btnExportar" OnClick="btnExportar_Click"><i class="fa fa-download exporticon faborde" title="Exportar Items"></i></asp:LinkButton>
            </h4>
        </div>
        <div class="col-4 text-right">
            <asp:Button ID="btnNuevoItem" Text="Nuevo Item" runat="server" CssClass="btn btn-primary" OnClick="btnNuevoItem_Click" />
        </div>
    </div>
    ...
    <div class="table-responsive">
        <asp:GridView ID="grdItems" CssClass="table table-striped table-bordered table-hover table-sm" runat="server" AutoGenerateColumns="false" OnRowCommand="grdItems_RowCommand">
            <Columns>
                ...
                <asp:BoundField DataField="CuentaID" HeaderText="Cuenta Contable" Visible="false" />
                <asp:BoundField DataField="CuentaDescripcion" HeaderText="Cuenta Contable" Visible="true" />
                <asp:BoundField DataField="Cantidad" HeaderText="Cantidad" Visible="true" />
                <asp:BoundField DataField="Peso" HeaderText="Peso" Visible="true" />
